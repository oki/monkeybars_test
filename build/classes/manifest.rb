...
when Monkeybars::Resolver::IN_FILE_SYSTEM
  ...
  add_to_load_path "../lib/ruby/mechanize/lib"
  add_to_load_path "../lib/ruby/nokogiri/lib"
  add_to_load_path "../lib/ruby/jruby-openssl/lib"
  add_to_load_path "../lib/ruby/foxyfox"

  # Files to be added only when running from the file system go here
when Monkeybars::Resolver::IN_JAR_FILE
  add_to_load_path "../lib/ruby/mechanize/lib"
  add_to_load_path "../lib/ruby/nokogiri/lib"
  add_to_load_path "../lib/ruby/nokogiri"
  add_to_load_path "../lib/ruby/nokogiri/ext/nokogiri"
  add_to_load_path "../lib/ruby/jruby-openssl/lib"
  add_to_load_path "../lib/ruby/foxyfox"
end
